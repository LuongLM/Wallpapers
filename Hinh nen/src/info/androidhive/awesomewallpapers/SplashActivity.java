...
public class SplashActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String url = AppConst.URL_PICASA_ALBUMS
				.replace("luogle95", AppController.getInstance()           // _PICASA_USER_////////////////////////////////
						.getPrefManger().getGoogleUserName());
		
		Log.d(TAG, "Albums yêu cầu url: " + url);
		...
		JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.GET, url,
				null, new Response.Listener<JSONObject>() {
					...
					public void onResponse(JSONObject response) {
						Log.d(TAG, "Sự trả lời các albums: " + response.toString());
					...
					public void onErrorResponse(VolleyError error) {
						Log.e(TAG, "Lỗi thư viện volley: " + error.getMessage());
