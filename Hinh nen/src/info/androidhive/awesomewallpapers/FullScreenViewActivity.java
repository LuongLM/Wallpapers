...
public class FullScreenViewActivity extends Activity implements OnClickListener {
	...
	public static final String TAG_SEL_IMAGE = "Ảnh được chọn";
	...
	/**
	 * Fetching image full resolution json
	 * */
		...
		JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.GET, url,
				null, new Response.Listener<JSONObject>() {
					...
					public void onResponse(JSONObject response) {
						Log.d(TAG,
								"Độ phân giải hình ảnh đầy đủ json: "
										+ response.toString());
						try {
							...
							Log.d(TAG, "Hình ảnh có độ phân giải đầy đủ. url: "
	...
	private void adjustImageAspect(int bWidth, int bHeight) {
		...
		Log.d(TAG, "Kích thước mới ảnh toàn màn hình: w = " + new_width
				+ ", h = " + sHeight);
