...
public class PrefManager {
	...
	private static final String PREF_NAME = "Hình nền";

	// Google's username
	private static final String KEY_GOOGLE_USERNAME = "Tài khoản Google";

	// No of grid columns
	private static final String KEY_NO_OF_COLUMNS = "Số cột lưới";

	// Gallery directory name
	private static final String KEY_GALLERY_NAME = "Tên bộ sưu tập";

	// gallery albums key
	private static final String KEY_ALBUMS = "Tập ảnh";
	...
	public String getGoogleUserName() {
		return pref.getString(KEY_GOOGLE_USERNAME, AppConst.LUOGLE95);
	}
	...
	public void storeCategories(List<Category> albums) {
		...
		Log.d(TAG, "Tên tập ảnh: " + gson.toJson(albums));
